...
var css$7 = "\nsvg[data-v-09d1a3b8] {\n  height: 1em;\n  width: 1em;\n  fill: rgb(23, 41, 64);\n}\n.version .v-icon[data-v-09d1a3b8] {\n  color: var(--foreground-subdued);\n  transition: color var(--fast) var(--transition);\n}\n.version[data-v-09d1a3b8] .v-text-overflow {\n  color: var(--foreground-subdued);\n  transition: color var(--fast) var(--transition);\n}\n.version:hover .v-icon[data-v-09d1a3b8] {\n  color: var(--foreground-normal-alt);\n}\n.version[data-v-09d1a3b8]:hover .v-text-overflow {\n  color: var(--foreground-normal-alt);\n}\n";
n(css$7,{});

script$5.render = render$5;
script$5.__scopeId = "data-v-09d1a3b8";
script$5.__file = "src/components/navigation.vue";

var script$4 = {
  components: { NavbarComponent: script$5 },
  data() {
    return {
      version,
    };
...
const _withScopeId$2 = n => (pushScopeId("data-v-580b67a6"),n=n(),popScopeId(),n);
...
script$4.__scopeId = "data-v-580b67a6";
script$4.__file = "src/routes/index.vue";
...
var script$3 = {
  ...
  computed: {
    rendered() {
      return prism.exports.highlight(
        this.value,
        prism.exports.languages[this.language],
        this.language
      );
    }
  },
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", _hoisted_1$3, [
    createElementVNode("i", null, [
      createTextVNode(toDisplayString($props.downloadName) + " ", 1 /* TEXT */),
      ($props.loading && $options.rendered)
        ? (openBlock(), createBlock(_component_v_progress_circular, {
            key: 0,
            indeterminate: "",
      ...
      ($setup.isCopySupported)
        ? (openBlock(), createBlock(_component_v_button, {
            ...
            default: withCtx(() => [
              ...
              createTextVNode(" " + toDisplayString($setup.t('copy')), 1 /* TEXT */)
            ]),
            _: 1 /* STABLE */
          }, 8 /* PROPS */, ["onClick"]))
        : createCommentVNode("v-if", true),
      (this.downloadName)
        ? (openBlock(), createBlock(_component_v_button, {
            ...
            default: withCtx(() => [
              ...
              createTextVNode(" " + toDisplayString($setup.t('download')), 1 /* TEXT */)
            ]),
            _: 1 /* STABLE */
          }, 8 /* PROPS */, ["onClick"]))
        : createCommentVNode("v-if", true)
...
script$3.__scopeId = "data-v-c2ff9106";
script$3.__file = "src/components/code.vue";
...
async function getCollections(api) {
    const collectionsRes = await api.get("/collections?limit=-1");
    ...
    const fieldsRes = await api.get("/fields?limit=-1");
    ...
    const relationsRes = await api.get("/relations?limit=-1");
    const relations = relationsRes.data.data;
    relations.forEach((relation) => {
        if (collections[relation?.meta?.one_collection]) {
        ...
        if (collections[relation?.meta?.many_collection]) {
...
async function generateTsTypes(api, useIntersectionTypes = false) {
...
var script$2 = {
  components: { NavbarComponent: script$5, CodeComponent: script$3 },
  inject: ["api"],
  data() {
    return {
      types: "",
...
const _withScopeId$1 = n => (pushScopeId("data-v-3bdb8ddb"),n=n(),popScopeId(),n);
...
const _hoisted_5 = /*#__PURE__*/ _withScopeId$1(() => /*#__PURE__*/createElementVNode("h3", { class: "type-title" }, "Options", -1 /* HOISTED */));
const _hoisted_6 = /*#__PURE__*/ _withScopeId$1(() => /*#__PURE__*/createElementVNode("span", null, [
...
script$2.__scopeId = "data-v-3bdb8ddb";
script$2.__file = "src/routes/ts.vue";
...
const _withScopeId = n => (pushScopeId("data-v-1c0b6b35"),n=n(),popScopeId(),n);
...
script$1.__scopeId = "data-v-1c0b6b35";
script$1.__file = "src/routes/oas.vue";

async function generatePyTypes(api) {
    const collections = await getCollections(api);
    let ret = "";
    const types = [];
...
script.__scopeId = "data-v-355cb865";
script.__file = "src/routes/py.vue";
