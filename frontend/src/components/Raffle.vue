// from https://github.com/jamacon36/vue-raffle-wheel/tree/fed46d57dffcba9e7c4513ca2746dbad5d68c8bf
/*
Copyright (c) 2021, James Macon
...
<template>
  <div class="raffle-wheel">
    <button v-if="!hideButton" class="raffle-wheel__button" @click="spin" :disabled="blockSpin">
      {{ buttonText }}
    </button>
    <canvas class="raffle-wheel__canvas" ref="wheel" :width="canvasWidth" :height="canvasHeight"></canvas>
  </div>
</template>
